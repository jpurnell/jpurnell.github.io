...
- _Which assumptions matter most?_ If revenue drops 10%, does the project still work?
- _What's the range of outcomes?_ Best case, base case, worst case—how different are they?
- _Which input should we focus on?_ Would raising prices or cutting costs be more impactful?
- _How do inputs interact?_ If revenue drops AND costs rise, what happens?
...
**Alternative (anti-pattern)**: Treating the _dollar amount_ of `COGS` as an independent primitive will give 100% revenue passthrough—unrealistic for businesses with variable costs!

...
→ Full API Reference: [**BusinessMath Docs – 3.9 Equity Valuation**](https://github.com/jpurnell/BusinessMath/blob/main/Sources/BusinessMath/BusinessMath.docc/3.9-EquityValuationGuide.md)
...
**Related Methodology**: [Documentation as Design](../week-02/02-tue-documentation-as-design) (Week 2) - We wrote tutorial examples first to ensure APIs were learnable before implementing.

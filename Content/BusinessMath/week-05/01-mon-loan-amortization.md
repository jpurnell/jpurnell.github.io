...
for month in 1...12 {
    ...
    print("  \(month)   | \(principalPmt.currency()) | \(interestPmt.currency()) | \(remainingBalance.currency())")
}
```
...
------|------------|------------|------------
  ...
  2   | $300.14    | $1,498.51  | $299,401.21
  3   | $301.64    | $1,497.01  | $299,099.57
  4   | $303.14    | $1,495.51  | $298,796.43
  ...
 12   | $315.18    | $1,483.47  | $296,315.96
```
...
print("\nKey Insights:")
print("  • 15-year term saves \((totalInterest - interest15yr).currency()) in interest")
...
-------------------|-----------|------------|----------------
30-year @ 6.00%    | $1,798.65 | $647,514  | $347,514
15-year @ 6.00%    | $2,531.57 | $455,682  | $155,682
30-year @ 5.00%    | $1,610.46 | $579,767  | $279,767
...
Results:
  Payoff time: 297 months (24.8 years)
  Time saved: 63 months (5.2 years)
  Interest saved: $89,237
  Total paid: $593,399
```
...
```
→ Download: Week05/LoanAmortization.playground
...
1. **Flexibility**: Users can generate partial schedules, skip periods, or apply custom logic
...
**Related Methodology**: [Test-First Development](../week-01/02-tue-test-first-development.md) (Week 1) - We wrote tests for edge cases like $0 balance, negative rates, and payment #1 vs. #360 before implementing.
